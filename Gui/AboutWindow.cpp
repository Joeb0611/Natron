 ...
 *
 * Modified 2026-09-16: About box fork attribution for Natron+.
 *
    ...
    : QDialog(parent)
{
    ...
    {
        QString forkNotice = QString::fromUtf8(
            "<p>%1 is a fork of <a href=\"https://natrongithub.github.io\">Natron</a> "
            "(INRIA / Alexandre Gauthier-Foichat / Natron developers). "
            "It is not an official Natron Project build, org, or release.</p>")
                             .arg( QString::fromUtf8(NATRON_APPLICATION_NAME) );
        aboutText.append(forkNotice);
    }
    {

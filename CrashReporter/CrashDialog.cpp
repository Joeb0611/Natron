    ...
    , _contactMe(0)
{
    ...
    if ( qss.open(QIODevice::ReadOnly
        ...
        setStyleSheet( content
                       .arg( QString::fromUtf8("rgb(243,149,0)") )
                       .arg( QString::fromUtf8("rgb(50,50,50)") )
                       .arg( QString::fromUtf8("rgb(71,71,71)") )
                       .arg( QString::fromUtf8("rgb(38,38,38)") )
                       .arg( QString::fromUtf8("rgb(150,150,150)") )
                       .arg( QString::fromUtf8("rgb(86,117,156)") )
                       .arg( QString::fromUtf8("rgb(21,97,248)") )
                       .arg( QString::fromUtf8("rgb(200,200,200)") )
                       .arg( QString::fromUtf8("rgb(180,200,100)") )
                       .arg( QString::fromUtf8("rgb(150,150,50)") )
                       .arg( QString::fromUtf8("rgb(255,195,120)") ) );
    }
    ...
    setWindowTitle( tr("Problem Report for %1 ").arg( QString::fromUtf8(NATRON_APPLICATION_NAME) ) + QString::fromUtf8(NATRON_VERSION_STRING) );
    ...
    QPixmap pix( QString::fromUtf8(":Resources/Images/natronplusIcon.xpm") );
    ...
    edit->setPlaceHolderText( tr("Describe here useful info for the developers such as how to reproduce the crash and what you were doing prior to the crash.") );
    _descEdit = edit;
...
{
    QString features;
    if (_feat01Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat01Box->text()); }
    if (_feat02Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat02Box->text()); }
    if (_feat03Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat03Box->text()); }
    if (_feat04Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat04Box->text()); }
    if (_feat05Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat05Box->text()); }
    if (_feat06Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat06Box->text()); }
    if (_feat07Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat07Box->text()); }
    if (_feat08Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat08Box->text()); }
    if (_feat09Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat09Box->text()); }
    if (_feat10Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat10Box->text()); }
    if (_feat11Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat11Box->text()); }
    if (_feat12Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat12Box->text()); }
    if (_feat13Box->isChecked()) { if (!features.isEmpty()) features.append(QString::fromUtf8(", ")); features.append(_feat13Box->text()); }
    return features;
}

QString CrashDialog::getGLrenderer() const { return _GLrenderer; }
QString CrashDialog::getGLversion() const { return _GLversion; }
QString CrashDialog::getGLvendor() const { return _GLvendor; }
QString CrashDialog::getGLshader() const { return _GLshader; }
QString CrashDialog::getGLext() const { return _GLext; }
...
CrashDialog::onSendClicked()
{
    ...
    if ( description.isEmpty() ) {
        QMessageBox ques(QMessageBox::Question, tr("Empty description"), tr("The issue report doesn't have any description. Would you like to send it anyway?"),
...
CrashDialog::onSaveClicked()
{
    ...
    bool saveOk = false;
    QString saveFileName = QFileDialog::getSaveFileName(this, tr("Save report"), fileName, QString::fromUtf8("*.dmp"), 0, 0);
    ...
    if (!saveOk) {
        QMessageBox ques(QMessageBox::Critical, tr("Invalid filename"), tr("The issue could not be saved to: ") + saveFileName,
                         QMessageBox::Ok, this, Qt::Dialog | Qt::MSWindowsFixedSizeDialogHint | Qt::WindowStaysOnTopHint);
        ques.setWindowFlags(ques.windowFlags() | Qt::WindowStaysOnTopHint);
        ques.exec();
        return;
    }
